...
public enum SystemErrorType implements ErrorType {
    ...
    SYSTEM_ERROR(SYSTEM_ERROR_CODE_PRE + 1000, "系统异常"),
    SYSTEM_BUSY(SYSTEM_ERROR_CODE_PRE + 1001, "系统繁忙,请稍候再试"),
    GATEWAY_CONNECT_TIME_OUT(SYSTEM_ERROR_CODE_PRE + 1002, "网关超时"),
    PARAM_INVALID(SYSTEM_ERROR_CODE_PRE + 1003, "参数异常"),
    SERVICE_RUN_TIMEOUT(SYSTEM_ERROR_CODE_PRE + 1004, "服务运行超时"),
    ...
    DATE_FORMAT_ERROR(DATE_ERROR_CODE_PRE + 1001, "日期格式化错误"),
    DATE_SCOPE_ERROR(DATE_ERROR_CODE_PRE + 1002, "时间范围错误");
