package com.runyuanj.core.jwt.utils;

import cn.hutool.core.util.StrUtil;
import com.google.common.base.Charsets;
import com.runyuanj.core.context.BaseContextConstants;
import com.runyuanj.core.exception.BizException;
import com.runyuanj.core.exception.code.ExceptionCode;
import com.runyuanj.core.jwt.model.Token;
...
import static com.runyuanj.core.context.BaseContextConstants.BASIC_HEADER_PREFIX;
import static com.runyuanj.core.exception.code.ExceptionCode.JWT_BASIC_INVALID;
  ...
  /*  *//**
    ...
    *//**
    ...
    public static String base64Decoder(String header) {
        byte[] decoded = Base64.getDecoder().decode(header.getBytes(Charsets.UTF_8.name()));
        return new String(decoded, Charsets.UTF_8.name());
    }
